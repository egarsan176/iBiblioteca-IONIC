...
// To parse this data:
//
//   import { Convert, Biblioteca } from "./file";
//
//   const biblioteca = Convert.toBiblioteca(json);
//
...
export class Convert {
    public static toBiblioteca(json: string): Biblioteca {
        return cast(JSON.parse(json), r("Biblioteca"));
    }

    public static bibliotecaToJson(value: Biblioteca): string {
        return JSON.stringify(uncast(value, r("Biblioteca")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Doc": o([
        ...
        { json: "id_bodleian__oxford_university", js: "id_bodleian__oxford_university", typ: u(undefined, a("")) },
        ...
        { json: "id_abebooks_de", js: "id_abebooks_de", typ: u(undefined, a("")) },
        ...
        { json: "id_project_gutenberg", js: "id_project_gutenberg", typ: u(undefined, a("")) },
